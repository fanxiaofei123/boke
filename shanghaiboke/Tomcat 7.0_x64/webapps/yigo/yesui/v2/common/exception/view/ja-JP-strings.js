(function () {
	...
	var obj = {
		...
		LayerOrHiddernNoDefine: "設定に誤りがあります。グリッド階層のデータを表示するにはLayerとHiddenフィールドが必要です。",
		...
		NoComponentBudilderClass: "{1},{2} は関連のコンポーネントビルダークラスが存在しません。",
		...
		UnEqualParamNum: "パラメータの数が一致していません",
		AttachmentTypeError: "添付タイプ｛１｝は正しくありません"
	};
	YIUI.ViewException["ja-JP"] = obj;
