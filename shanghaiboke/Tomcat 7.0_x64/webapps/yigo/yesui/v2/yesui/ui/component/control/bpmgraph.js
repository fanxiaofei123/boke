...
//            this.mX = (maxX - minX) / 2 - this.el.width() / 2 + 50;
    ...
    obkiqueCurveHTwoBase: function (sourcePoint, targetPoint, mx1, mx2, transition) {
        ...
        switch (transition.tagName) {
            ...
            case "exception-flow" :
                var circle_center = lt.getPointAtLength(8.5);
                var image = this.paper.image("yesui/v2/yesui/ui/res/css/default/images/bpmgraph/ExceptionFlow-icon.png", (circle_center.x - 8.5 - this.mX), (circle_center.y - 8.5 - this.mY), 17, 17);
                break;
        }
    },
    ...
    filletCurveVTwoBase: function (sourcePoint, targetPoint, my, transition) {
        ...
        switch (transition.tagName) {
            ...
            case "exception-flow" :
                var circle_center = lt.getPointAtLength(8.5);
                var image = this.paper.image("yesui/ui/res/css/default/images/bpmgraph/ExceptionFlow-icon.png", (circle_center.x - 8.5 - this.mX), (circle_center.y - 8.5 - this.mY), 17, 17);
                break;
        }
    },
    ...
    steaightLineBase: function (sourcePoint, targetPoint, transition) {
        ...
        switch (transition.tagName) {
            ...
            case "exception-flow" :
                ...
                var image = this.paper.image("yesui/ui/res/css/default/images/bpmgraph/ExceptionFlow-icon.png", (circle_center.x - 8.5), (circle_center.y - 8.5), 17, 17);
                break;
        }
    },
    ...
    createUserTaskNode: function (node) {
        ...
        out.attr({"fill": "white"});
        //矩形内部图案
        var image = out.paper.image("yesui/v2/yesui/ui/res/css/default/images/bpmgraph/UserTask-icon.png", node.x + 2 - this.mX, node.y + 2 - this.mY, 18, 18);
    ...
    createMultiTaskNode: function (node) {
        ...
        out.attr({"fill": "white"});
        //矩形内部图案
        var image1 = out.paper.image("yesui/v2/yesui/ui/res/css/default/images/bpmgraph/SubProcess-icon.png", node.x + node.width / 2 - 10 - this.mX, node.y + node.height - 18 - this.mY, 18, 18);
        var image = out.paper.image("yesui/v2/yesui/ui/res/css/default/images/bpmgraph/MultiTask-icon.png", node.x + 2 - this.mX, node.y + 2 - this.mY, 18, 18);
        var text = out.paper.text(node.x + node.width / 2 - this.mX, node.y + node.height / 2 - this.mY, node.caption);
        if (this.isIE()) {
            this.textFormat(text);
        }
    ...
    createMultiAuditNode: function (node) {
        ...
        //矩形内部图案
        var image1 = out.paper.image("yesui/v2/yesui/ui/res/css/default/images/bpmgraph/SubProcess-icon.png", node.x + node.width / 2 - 10 - this.mX, node.y + node.height - 18 - this.mY, 18, 18);
        var image = out.paper.image("yesui/v2/yesui/ui/res/css/default/images/bpmgraph/MultiAudit-icon.png", node.x + 2 - this.mX, node.y + 2 - this.mY, 18, 18);
        var text = out.paper.text(node.x + node.width / 2 - this.mX, node.y + node.height / 2 - this.mY, node.caption);
        if (this.isIE()) {
            this.textFormat(text);
        }
    ...
    createServiceTaskNode: function (node) {
        ...
        out.attr({"fill": "white"});
        //矩形内部图案
        var image = out.paper.image("yesui/v2/yesui/ui/res/css/default/images/bpmgraph/ServiceTask-icon.png", node.x + 2 - this.mX, node.y + 2 - this.mY, 18, 18);
        var text = out.paper.text(node.x + node.width / 2 - this.mX, node.y + node.height / 2 - this.mY, node.caption);
        if (this.isIE()) {
            this.textFormat(text);
        }
    ...
    createManualTaskNode: function (node) {
        ...
        out.attr({"fill": "white"});
        //矩形内部图案
        var image = out.paper.image("yesui/v2/yesui/ui/res/css/default/images/bpmgraph/ManualTask-icon.png", node.x + 2 - this.mX, node.y + 2 - this.mY, 18, 18);
        var text = out.paper.text(node.x + node.width / 2 - this.mX, node.y + node.height / 2 - this.mY, node.caption);
        if (this.isIE()) {
            this.textFormat(text);
        }
    ...
    createAuditNode: function (node) {
        ...
        out.attr({"fill": "white"});
        //矩形内部图案
        var image = out.paper.image("yesui/v2/yesui/ui/res/css/default/images/bpmgraph/Audit-icon.png", node.x + 2 - this.mX, node.y + 2 - this.mY, 18, 18);
        var text = out.paper.text(node.x + node.width / 2 - this.mX, node.y + node.height / 2 - this.mY, node.caption);
        if (this.isIE()) {
            this.textFormat(text);
        }
    ...
    createSubProcessNode: function (node) {
        ...
        //矩形内部图案
        var image = out.paper.image("yesui/v2/yesui/ui/res/css/default/images/bpmgraph/SubProcess-icon.png", node.x + node.width / 2 - 10 - this.mX, node.y + node.height - 18 - this.mY, 18, 18);
    ...
    createInlineNode: function (node) {
        ...
        //矩形内部图案
        var image = out.paper.image("yesui/v2/yesui/ui/res/css/default/images/bpmgraph/Inline-icon.png", node.x + node.width / 2 - 10 - this.mX, node.y + node.height - 18 - this.mY, 18, 18);
    ...
    createDataMapNode: function (node) {
        ...
        //矩形内部图案
        var image = out.paper.image("yesui/v2/yesui/ui/res/css/default/images/bpmgraph/DataMap-icon.png", node.x + node.width / 2 - 10 - this.mX, node.y + node.height - 18 - this.mY, 18, 18)
        var text = out.paper.text(node.x + node.width / 2 - this.mX, node.y + node.height / 2 - this.mY, node.caption);
        if (this.isIE()) {
            this.textFormat(text);
        }
