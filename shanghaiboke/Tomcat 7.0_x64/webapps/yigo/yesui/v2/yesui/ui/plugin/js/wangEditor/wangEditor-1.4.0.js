        ...
        //弹出框
            ...
            btnClick = function(e){
                ...
                $(document).on("mousedown", function(event) {
                    ...
                    if(target.closest(".wangEditor-modal-container").length == 0) {
                        editor.hideModal();
...
$.extend($E.fn, {
    ...
    'init': function($textarea, options){
        ...
        */
        ...
        editor.isEnable = function() {
            var ct = editor.$editorContainer.parent();
            var enable = !ct.hasClass("ui-readonly");
            return enable;
        };
