			...
			fill = function(el) {
				...
				for (var i = 0; i < options.calendars; i++) {
					...
					while (cnt < 42) {
						...
						if((new Date()).setHours(0,0,0,0) ==val && options.date != val){
