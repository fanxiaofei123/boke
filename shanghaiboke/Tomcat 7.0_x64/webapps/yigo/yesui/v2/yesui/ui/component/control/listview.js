            	...
            	for (var j = 0, length = listView.columnInfo.length; j < length; j++) {
                    ...
                    switch(column.columnType){
                        ...
                        case YIUI.CONTROLTYPE.BUTTON:
                            ...
                            if(column.icon) {
                                $imginfo.style.cssText += " background-image: url('Resource/" + column.icon + "')";
                            } else {
    ...
    install: function () {
        ...
        $(".head th").hover(function(){
            ...
            for (var i = 0; i < parents.length; i++) {
              ...
              $(".rc-handle", self.$handleContainer).css({
    ...
    setValueAt: function(rowIndex, colIndex, value) {
        ...
        switch (column.columnType) {
            ...
            case YIUI.CONTROLTYPE.DICT:
                ...
                def = YIUI.DictHandler.getShowCaption(val, column.multiSelect, column.independent);
                break;
