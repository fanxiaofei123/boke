        ...
        var Return = {
            showError: function (errorMsg, type) {
                if(type == YIUI.Dialog_Type.WARN) {
                    ...
                    dialog.modalDialog(errorMsg, {title: YIUI.I18N.opt.warning, showClose: true, type: YIUI.Dialog_Type.WARN, height: 200, width: 400});
                } else {
    ...
    YIUI.CopyNewOpt = function (form) {
        var Return = {
            doOpt: function(){
                ...
                YIUI.DocService.copyNew(form).then(function (data) {
